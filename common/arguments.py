...
def get_args():
    ...
    parser.add_argument("--alg", type=str, default='MADDPG', help="type of algorithm")
    parser.add_argument("--actor-learn-step", type=int, default=10, help="actor learn step")
    ...
    parser.add_argument("--max-file-saved", type=int, default=5, help="maximum number of saved model files")
